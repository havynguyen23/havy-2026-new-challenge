...
export const generateMetadata = async () => {
  const t = await getTranslations('ManualTestingProjectPage');
  return customGenerateMetadata({
    PATH: ROUTES.MANUAL_TESTING_PROJECT.PATH,
    TITLE: t('title'),
    LABEL_KEY: '',
  });
};
...
const ManualTestingProject = () => {
  const t = useTranslations('ManualTestingProjectPage');
...
export default ManualTestingProject;
